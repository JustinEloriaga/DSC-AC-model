function r=tvsvar_modified_msv2_gam1(y,lags,T0,T0B,T0A,T0H,kB,kA,kH,M,nreport);
...
mat_rt = zeros(T, n_r, M);
% mat_n_r = zeros(M,1);
mat_sig2r = zeros(M,n_r);
mat_PT = zeros(m,m,1,M);
