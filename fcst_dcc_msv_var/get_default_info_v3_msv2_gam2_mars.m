function info = get_default_info_v3_msv2_gam2_mars()
...
% Evaluation period (MARS daily data uses YYYY-MM-DD format)
% NOTE: mars_inflation_portfolio is only available from ~2006-03-16 onward.
% Since we require all 4 series, eval_T0 must be well after 2006 to allow
% enough training observations before the evaluation window begins.
info.eval_T0 = '2008-01-02'; %starting of evaluation period
