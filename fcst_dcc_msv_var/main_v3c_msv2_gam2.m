% ======================================================================
% Part of the replication file for
% Arias, Rubio-Ramirez, Shin (2023), "Macroeconomic forecasting and
% variable ordering"
% ======================================================================

% ======================================================================
% 4/21/2024: Minchul believes that this is the final code that we used to
% produce results in our JE paper as far as DSC-AC model is concerned
% -> it takes 0.17 sec per draw
...
% "get_default_info_v3_msv2_gam2.m"
% 3. It is based on Elliptical slice sampling as described in our JE paper.
% It may not be the best method as far as efficiency is concerned. In the
% next project, we switched to particle Gibbs sampling, which seemed to be
% more efficient but at the cost of computation time. So, we do not know
% what is the best way to implement 
% 4. file is stored under "\pred_v4_msv2_gam2" 
...
ind_t = 1; % ind_t=1, estimation sample ends in 12/12016 (see how ind_t is used in main_estimation_and_forecast_v3c_msv_gam2.m)
